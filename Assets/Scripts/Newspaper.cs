...
public class Newspaper : MonoBehaviour
{
    ...
    {
        return
            "あなたはナリソメ村の新聞記者です。以下の村の記録を元に、\n" +
            "村の新聞記事を日本語で書いてください。\n" +
            "記事は300字以内で、見出しと本文で構成してください。\n" +
            "事実のみを書き、記号や装飾は使わないでください。\n" +
            "アルファベット・英語・ローマ字は絶対に使わないでください。\n" +
            "必ずひらがな・カタカナ・漢字だけで書いてください。\n" +
            "セリフや記事本文のみ出力し、前置きや説明は不要です。\n\n" +
            "【村の記録】\n" + history + "\n\n【新聞記事】\n";
    }
